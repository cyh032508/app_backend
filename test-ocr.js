 ...
 * node test-ocr.js
 * 或指定 API URL：
 * node test-ocr.js http://localhost:3000
 */
...
// 預設使用 Vercel 部署的 API（可透過命令列參數修改）
const API_BASE_URL = process.argv[2] || 'https://your-app.vercel.app'; // 請改成你的 Vercel URL
 ...
 * 獲取資料夾內的第一個圖片檔案
 */
async function getFirstImageFile(dirPath) {
 ...
 * 儲存辨識結果到 txt 檔案
 */
async function saveResult(folderName, imageName, ocrResult) {
